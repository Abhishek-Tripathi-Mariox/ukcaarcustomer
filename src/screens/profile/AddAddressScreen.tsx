...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, fontSize: 16, color: Colors.black, paddingVertical: 0 },
  clearBtn: { padding: 4 },
  ...
  currentLocTitle: { fontSize: 16, fontWeight: '600', color: Colors.black },
  currentLocSub: { fontSize: 13, color: '#7D8A95', marginTop: 2 },
  ...
  suggestionsTitle: { fontSize: 14, fontWeight: '600', color: '#7D8A95', textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  suggestionText: { flex: 1, fontSize: 15, color: Colors.black, lineHeight: 22 },
  suggestionSub: { fontSize: 12, color: '#7D8A95', marginTop: 2 },
  ...
  noResultsText: { fontSize: 15, color: '#7D8A95' },
  enterManuallyBtn: { marginTop: 12 },
  enterManuallyText: { fontSize: 16, fontWeight: '600', color: Colors.primary },
  ...
  detailsTitle: { fontSize: 20, fontWeight: '700', color: Colors.black },
  detailsContent: {
    paddingHorizontal: Spacing.xl,
  ...
  mapHintText: { fontSize: 13, color: '#7D8A95', textAlign: 'center' },
  mapLoading: {
    position: 'absolute',
    top: 10,
    right: 10,
  ...
  mapCaption: { fontSize: 12, color: '#7D8A95', marginTop: 6, textAlign: 'center' },
  ...
  labelChipText: { fontSize: 14, fontWeight: '500', color: '#7D8A95' },
  ...
  addrFieldInput: { flex: 1, fontSize: 16, color: Colors.black, paddingVertical: 0 },
  useCurrentBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  useCurrentText: { fontSize: 14, fontWeight: '600', color: Colors.primary },
  suggestionsDropdown: {
    borderWidth: 1,
    borderColor: '#E0E0E0',
    borderRadius: BorderRadius.base,
  ...
  ddText: { flex: 1, fontSize: 14, color: Colors.black, lineHeight: 20 },
  ddSub: { fontSize: 12, color: '#7D8A95', marginTop: 2 },
  ddError: { fontSize: 13, color: '#E07B00', padding: 12 },
